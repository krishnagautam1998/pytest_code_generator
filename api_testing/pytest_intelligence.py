...
input_folder = st.text_input("Enter the path of the folder containing Python files:", r'C:\genai\project\pytest_code_generator\api_testing\api')
output_folder = st.text_input("Enter the path of the folder to save Pytest files:", r'C:\genai\project\pytest_code_generator\api_testing\utils')

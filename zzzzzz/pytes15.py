...
# Initialize the environment variable for Google API key if not already set
...
# Initialize function_code as None
function_code = None
...
# Ensure that function_code is defined and valid before generating Pytest code
if submit:
    if function_code:
        ...
        st.error("Function code not fetched. Please fetch the function code before generating the Pytest code.")
